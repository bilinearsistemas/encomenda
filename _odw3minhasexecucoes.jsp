...
<head>
	<title>Minhas Execuï¿½ï¿½es</title>
	<meta charset="UTF-8">
	...
	<!-- Font Awesome -->
	<!-- <link rel="stylesheet" type="text/css" charset="UTF-8" href="../js/font-awesome-4.5.0/css/font-awesome.min.css"> -->
	...
	<link rel="stylesheet" type="text/css" href="app/_odw3minhasexecucoes/index.css">
</head>
...
<body>
    ...
    <!-- Page -->
    <script type="text/javascript" charset="UTF-8" src="app/_odw3minhasexecucoes/index.js"></script>
</body>
