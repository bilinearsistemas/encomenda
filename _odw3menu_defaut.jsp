...
<head>
    ...
    <!-- Favicon -->
	<link rel="icon" href="images/obs-s-t-50h.png" type="image/x-icon" />
...
<body class="skin-default">
    ...
    <header id="header" class="header">
        <nav class="navbar navbar-static-top" role="navigation">
            <a href="#" class="logo">
                <img src="images/obs-h-t-90h.png" alt="logo" style="height: 45px;"/>
            </a>
            ...
            <div class="navbar-right">
                <ul class="nav navbar-nav">
                    ...
                    <li>
                        <a href="#" class="logo">
                            <img src="images/ian-h-tp-30h.png" alt="logo" style="height: 30px; vertical-align: baseline; opacity: 0.5;"/>
                        </a>
                    </li>
                    <li>
                    ...
                    <li class="dropdown messages-menu tooltips" v-event:show.bs.dropdown="getUltimasExecucoes">
                        ...
                        <ul class="dropdown-menu dropdown-messages table-striped">
                            ...
                            <li class="dropdown-title"><a href="#" @click="openURL('odw3/_odw3minhasexecucoes.jsp', 'Minhas Execuções')">Visualizar Todas</a></li>
                    ...
                    <li class="dropdown messages-menu" v-event:show.bs.dropdown="getUltimasNotificacoes" v-event:hide.bs.dropdown="getPreferencias">
                        ...
                        <ul class="dropdown-menu dropdown-messages table-striped">
                            ...
                            <li class="dropdown-title"><a href="#" @click="openURL('odw3/_odw3minhasnotificacoes.jsp', 'Minhas Notificações')">Visualizar Todas</a></li>
					...
					<!-- Executor de tarefas -->
                    <li v-if="hasCadTarefas">
                        <a href="#" @click="execEngine()" class="dropdown-toggle" data-toggle-extra="tooltip" data-tooltip="tooltip" data-placement="bottom" :data-original-title="tooltipExecEngine" style="padding: 7px;">
                            <i class="fa fa-fw ti-time black" :class="execEngineStarted ? 'exec-engine-started' : 'exec-engine-stopped'"></i>
                        </a>
                    </li>					
                        ...
                        <li v-if="tabs[i]" v-for="(i, index) in indexes" :class="{ active: tabs[i] === active }" 
                            ...
                            <a href="#" @click.stop="setActive(tabs[i])">
                                ...
                                <span class="pull-right">
                                    <i class="fa fa-fw ti-close clickable" v-on:click.stop="close(i)"></i>
                                </span>
                                <span class="pull-right">
