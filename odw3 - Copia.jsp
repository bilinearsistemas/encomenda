...
<head>
    ...
    -->
    <link rel="stylesheet" href="odw3/login/styles.css">
                        ...
                        <div class="row">
                            <div class="col-xs-12">
                                <form v-on:submit.prevent="onSubmit" method="post">
                                    <of-input label="" v-model="usr" name="usr" :add-ons="{ left: addOns.usr }"></of-input>
                                    <of-input label="" v-model="pwd" name="pwd" :add-ons="{ left: addOns.pwd }" :is-secret="true"></of-input>
